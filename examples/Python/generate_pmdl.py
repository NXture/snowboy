...
def main():
    ...
    parser.add_argument('-rD', '--recording-dir', dest="recordDir",
                        help="The directory containing the recording wav files")
    parser.add_argument('-r1', '--record1', dest="record1",
                        help="Record voice 1")
    parser.add_argument('-r2', '--record2', dest="record2",
                        help="Record voice 2")
    ...
    enroll = SnowboyPersonalEnroll(
        resource_filename=snowboy_pmdl_config.get_enroll_resource(
            args.language),
    ...
    print("channels: %d, sample rate: %d, bits: %d" %
